...
BACKEND_URL = os.getenv("BACKEND_URL", "").strip().rstrip("/") or origin_of(WEB_APP_URL)
WEBHOOK_PATH = "/webhook"
WEBHOOK_SECRET = os.getenv("WEBHOOK_SECRET", "").strip() or hashlib.sha256(f"naba-webhook:{BOT_TOKEN}".encode()).hexdigest()
